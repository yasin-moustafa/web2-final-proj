...
<?php echo $__env->make('admin.layout.slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2021 <a href="<?php echo e(asset('https://adminlte.io')); ?>">AdminLTE.io</a>.</strong>
        All rights reserved.
...
<script src="<?php echo e('dist/js/demo.js'); ?>"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo e('dist/js/pages/dashboard2.js'); ?>"></script>
</body>
</html>

<?php /**PATH C:\Users\Mu7and\Desktop\store\store\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>